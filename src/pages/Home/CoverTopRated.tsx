...
import { useFetchNowPlayingMovies, useFetchTopRatedMovies, useFetchTrendingMovies } from "#lib/api";
...
const CoverTopRated = () => {
	const { data: dataMovies } = useFetchTopRatedMovies();
	const { data: dataTVSeries } = useFetchNowPlayingMovies();
